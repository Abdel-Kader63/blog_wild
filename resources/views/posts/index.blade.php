...
<h1 class="flex justify-center font-extrabold text-3xl m-5">Articles</h1>
        ...
        @foreach ($posts as $post)
			<div class="flex flex-col ">
				...
				<form method="POST" action="{{ route('posts.destroy', $post) }}" >
					...
					@method("DELETE")
					<button type="button" class=" focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-green-600 bg-green-700" style="background : #fca537 ; color : white ; justify-content :center ; display :flex ; align-items : center ; padding : 0.9rem 1rem ; font-size: 1.1rem ; width : 60%">
